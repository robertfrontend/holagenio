...
const MainCard = ({ children, title, description }) => {
  return (
    <div className="flex flex-col items-center justify-start w-[100%] md:w-[600px] min-h-[40vh] mx-auto pb-10 border border-gray-200 rounded-md bg-white shadow-lg px-2 md:p-6">
